...
<div class="container-default">
  ...
  <div class="row presentation">
      ...
      <div class="col-lg-8 col-md-6 titles">
        <span class="icon color7-bg"><i class="fa fa-th"></i></span>
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
              ...
              echo '<div class="panel panel-default panel-collapse">
                ...
                <div id="collapse'.$i.'" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                  ...
                  $cnt = $db->count;
                  for ($x = 0; $x < $cnt; $x++){
                    $nminduk = $induk[$x]['nama_induk'];
                    echo '
                      <br>
                          <blockquote>
                                  <p>'.$nminduk.'</p>
                                  <footer>Jadwal Kegiatan</footer>
                          </blockquote>
                    ...
                    <tbody>';
                    $idinduk = $induk[$x]['id_induk'];
                    $db->where('id_induk', $idinduk);
                    $kegiatan=$db->get('kegiatan');
                    $cont = $db->count;

                    for ($z = 0; $z < $cont; $z++){
                    $idwilayah = $kegiatan[$z]['id_wilayah'];
                    $idjenis = $kegiatan[$z]['id_jenis'];
                    $idkegiatan = $kegiatan[$z]['id_kegiatan'];
                    $db->where('id_wilayah', $idwilayah);
                    $wilayah=$db->get('wilayah_kegiatan');

                    $nmkegiatan = $kegiatan[$z]['nama_kegiatan'];
                    ...
                    $jml = $z+1;
                      ...
                      <td><a href="detail-kegiatan.php?id='.$idkegiatan.'">'.$nmkegiatan.'</a></td>
                      <td>'.$wilayah[0]['wilayah'].'</td>
                      <td>'.$jenis[0]['jenis'].'</td>
                    </tr>';
                  }
                  echo '
