...
<div class="container">
	<div class="row">
	<div class="row presentation" style="background: url(assets/img/home-kode.jpg); background-size: 100% 100%;
		min-height: 70px;
        min-width: 50px;
        width: 100%;
        height: 50px;
...
        left: 0;">
        ...
        <span class="icon color15-bg"><i class="fa fa-home"></i></span>
...
<div class="container-padding">
  ...
  <div class="col-md-6 col-lg-4">
        <div class="panel panel-primary">
          ...
          <img src="assets/img/kegiatan-icon.png" alt="icon" style="width:100px">
          </div>
      ...
      <div class="panel panel-success">
        ...
        <center>
        <div class="panel-body">
        <img src="assets/img/kalender-icon.png" alt="icon" style="width:100px">
        </div>
    ...
    <div class="col-md-6 col-lg-4">
      <div class="panel panel-warning">
        ...
        <center>
        <div class="panel-body">
        <img src="assets/img/pagu-icon.png" alt="icon" style="width:100px">
        </div>
...
<div class="row">
   <!-- //////////////  <div class="col-md-12">
              <div class="col-md-12 col-lg-4" style="text-align:center">
                <h5>Jenis Kegiatan</h5>
                 <form class="form-horizontal">
                   <fieldset>
				    <div class="form-group"class="col-md-12 col-lg-3">
					<label class="control-label form-label"></label>
				      <select class="selectpicker">
					  <option>RDK</option>
                        <option>RDK Narsum</option>
              ...
              <div class="col-md-12 col-lg-4" style="text-align:center">
                <h5>Tanggal Mulai - Tanggal Selesai</h5>
                 <form class="form-horizontal">
                   <fieldset>
                ...
                ';
                 ...
                 for($y=0; $y<$count;$y++){
                   ...
                   <tr>
                       ...
                       echo'</td>
                       <td><a href="#" class="btn btn-sm btn-option1" data-toggle="modal" data-target="#'.$kegiatan[$y]['id_kegiatan'].'"><i class="fa fa-paper-plane-o"></i>Lihat Detail</a></td>
